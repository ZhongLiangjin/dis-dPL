...
if __name__ == '__main__':
    # set hyperparameters
    modelType = 'TL-a'  # one of ['TL-a', 'TL-b', 'TL-c', 'TL-d', 'dPL']
    ...
    seed = 908331  # [668823, 759826, 211765, 908331, 808530, 178716]
    wStationLoss = {'TNH': 1, 'MAQ': 1, 'JIM': 1, 'HHY': 0.5}  # loss weights for different stations
    patience = 15
    clip = 0.5
    gpuId = 0
    ...
    # config model
    staNet = OrderedDict(hidFC=128, outFC=5, nAttr=70, nMet=3, spinUp=spinUp,
                         nKernel=[10, 5, 1], kernelSz=[7, 5, 3], stride=[1, 1, 1], poolSz=[3, 2, 1])
    dynNet = OrderedDict(inLSTM=73, hidLSTM=128, outLSTM=3)
